...
\begin{itemize}
    \item \textbf{R1:} At any time, The system shall allow users to sign up and login. 
    
    \subsubsection{Tournament and Battle Creation}

    \item \textbf{R2:} At any time, The system shall allow logged in educators to create tournaments.
    \item \textbf{R3:} When creating a tournament, the educator that is doing so must be able to set the registration deadline.
    \item \textbf{R4:} When creating a tournament, the educator that is doing so must be able to set a name.
    \item \textbf{R5:} After the creation of a tournament, the system shall notify all the students that a tournament has been created.
    \item \textbf{R6:} At any time, The system shall allow logged in educators to invite other logged in educators to tournaments.
    \item \textbf{R7:} At any time, The system shall allow logged in educators to create battles.
    \item \textbf{R8:} When creating a battle, the educator that is doing so must be able to upload a description of the problem.
    \item \textbf{R9:} When creating a battle, the educator that is doing so must be able to choose the programming language.
    \item \textbf{R10:} When creating a battle, the educator that is doing so must be able to set the registration deadline.
    \item \textbf{R11:} When creating a battle, the educator that is doing so must be able to set the final submission deadline.
    \item \textbf{R12:} When creating a battle, the educator that is doing so must be able to set the minimum and maximum number of participants per group.
    \item \textbf{R13:} When creating a battle, the educator that is doing so must be able to upload the test cases that will be used to evaluate the students code.
    \item \textbf{R14:} When creating a battle, the educator that is doing so must be able to upload the build automation scripts that will be used to evaluate the students code.
    \item \textbf{R15:} After the creation of a battle, the system shall notify all students that are registered to the tournament the battle belongs to that a battle has been created.

    \subsubsection{Tournament and Battle Registration}

    \item \textbf{R16:} At any time, The system shall allow logged in students to see the list of all tournaments.
    \item \textbf{R17:} At any time, The system shall allow logged in students to register to tournaments before the registration deadline of said tournament.
    \item \textbf{R18:} At any time, The system shall allow logged in students to cancel their registration to tournaments they belong to before the registration deadline of said tournament.
    \item \textbf{R19:} At any time, The system shall allow logged in students to see the description of the battles of a tournament they belong to.
    \item \textbf{R20:} At any time, The system shall allow logged in students to register to battles of a tournament they belong to before the registration deadline of said battle.
    \item \textbf{R21:} When registering to a battle, the student that is doing so must be able to invite other students to the battle.
    \item \textbf{R22:} At any time, The system shall allow logged in students to accept invitations to battles of a tournament they belong to before the registration deadline of said battle.
    \item \textbf{R23:} At any time, The system shall allow logged in students to cancel their registration to battles they belong to before the registration deadline of said battle.
    
    \subsubsection{Leaderboards}

    \item \textbf{R24:} At any time, The system shall allow logged in users to see the leaderboard of any tournament.
    \item \textbf{R25:} At any time, The system shall allow logged in users to see the leaderboard of any battle.
    
    \subsubsection{Submissions and Evaluations}

    \item \textbf{R26:} When the registration deadline of a battle expires, the system shall create a GitHub repository for the battle that the students should fork to make submissions. This repository should have the github actions workflow set up to receive notifications from GitHub when a commit is pushed to the main branch. This way when students fork the github actions of the fork will be already set up.
    \item \textbf{R27:} When the registration deadline of a battle expires, the system shall create a GitHub repository with the appropiate files, including the automation scripts and test cases files for the battle that the system will use to evaluate the submissions of the students.
    \item \textbf{R28:} When the registration deadline of a battle expires, the system shall send invitations to the GitHub repository used for submissions of the battle to the students that registered to it.
    \item \textbf{R29:} At any time, the system should be able to receive notifications from GitHub that a commit has been pushed to the main branch of one of the forked repositories of the battle.
    \item \textbf{R30:} The system should be able to pull the latest sources from the forked repository of the battle that the notification came from.
    \item \textbf{R31:} The system should be able to upload the latest sources from the forked repository of the battle that the notification came from, to the evaluation repository of the battle.
    \item \textbf{R32:} The system should be able to receive the results of the evaluation from the evaluation repository of the battle.
    \item \textbf{R33:} The system should be able to update the leaderboard of the battle with the results of the evaluation.
    
    \subsubsection{Manual Evaluations}

    \item \textbf{R34:} Once the final submission deadline of a battle expires, the system shall allow the educator that created the battle to manually evaluate the submissions of the students.
    \item \textbf{R35:} Once the educator that created the battle finishes manually evaluating the submissions of the students and closes the battle, the system shall update the leaderboard of the battle with the results of the manual evaluation.
    
    \subsubsection{Battle and Tournament Closing}

    \item \textbf{R36:} Once the educator that created the battle finishes manually evaluating the submissions of the students and closes the battle, the system shall notify all the students that participated in the battle that the final results have been published.
    \item \textbf{R37:} Once the educator that created the battle finishes manually evaluating the submissions of the students and closes the battle, the system shall update the leaderboard of the tournament that the battle belongs to by adding the score that each student got on the battle to their score on the rest of the battles of the tournament that they have participated on.
    \item \textbf{R38:} At any time, the system shall allow the owner of a tournament to close it.
    \item \textbf{R39:} Once the owner of a tournament closes it, the system shall update the leaderboard of the tournament and notify all the students that participated on it that the tournament has ended.
    
    \subsubsection{Tournament Search}

    \item \textbf{R40:} At any time, the system shall allow logged in students to search for tournaments. The system should return the tournaments that match the search criteria. This criteria is given by the keywords the student searched for, the tags the student selected, the programming language the student selected and the difficulty level the student selected.
